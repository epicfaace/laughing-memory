...
X_train, Y_train, train_ids = data_aug(TRAIN_PATH, TEST_PATH, IMG_WIDTH, IMG_HEIGHT, IMG_CHANNELS)
...
MODEL_NAME = 'model-dsbowl2018-Data-Aug-10-MeanIoU-10e-Res256'
...
results = model.fit((X_train), (Y_train), validation_split=len(train_ids) / len(X_train) * 0.1, batch_size=16, epochs=5, 
...
model = keras.models.load_model(MODEL_NAME + 'h5', custom_objects={'mean_iou': mean_iou}) 
